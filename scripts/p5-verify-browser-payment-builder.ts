...
import { buildFirstFundingInstructions, buildProtectedPaymentInstructions, buildRecipientOnboardingInstructions } from "../src/lib/paymentWorkflow.ts";
...
if (publicBytes > 1_232 || privateBytes > 1_232 || firstRecipientPublicBytes > 1_232 || recipientOnboardingBytes > 1_232 || firstFundingBytes > 1_232) throw new Error("Browser transaction exceeds Solana's packet limit");
