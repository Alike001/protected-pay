...
export const DELEGATE_PAYMENT_PERMISSION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([155, 170, 189, 169, 147, 218, 236, 255]);

export function getDelegatePaymentPermissionDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DELEGATE_PAYMENT_PERMISSION_DISCRIMINATOR,
  );
}

export type DelegatePaymentPermissionInstruction<
...
export type DelegatePaymentPermissionInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type DelegatePaymentPermissionInstructionDataArgs = {};

export function getDelegatePaymentPermissionInstructionDataEncoder(): FixedSizeEncoder<DelegatePaymentPermissionInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: DELEGATE_PAYMENT_PERMISSION_DISCRIMINATOR,
    }),
  );
}

export function getDelegatePaymentPermissionInstructionDataDecoder(): FixedSizeDecoder<DelegatePaymentPermissionInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getDelegatePaymentPermissionInstructionDataCodec(): FixedSizeCodec<
  DelegatePaymentPermissionInstructionDataArgs,
  DelegatePaymentPermissionInstructionData
> {
  return combineCodec(
    getDelegatePaymentPermissionInstructionDataEncoder(),
    getDelegatePaymentPermissionInstructionDataDecoder(),
  );
}

export type DelegatePaymentPermissionAsyncInput<
...
export async function getDelegatePaymentPermissionInstructionAsync<
  TAccountPayer extends string,
  TAccountSender extends string,
  TAccountConfig extends string,
  TAccountPayment extends string,
...
>(
  input: DelegatePaymentPermissionAsyncInput<
    TAccountPayer,
    TAccountSender,
    TAccountConfig,
    TAccountPayment,
  ...
  DelegatePaymentPermissionInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountSender,
    TAccountConfig,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDelegatePaymentPermissionInstructionDataEncoder().encode({}),
    programAddress,
  } as DelegatePaymentPermissionInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountSender,
    TAccountConfig,
...
export type DelegatePaymentPermissionInput<
  TAccountPayer extends string = string,
  TAccountSender extends string = string,
  TAccountConfig extends string = string,
  TAccountPayment extends string = string,
...
export function getDelegatePaymentPermissionInstruction<
  TAccountPayer extends string,
  TAccountSender extends string,
  TAccountConfig extends string,
  TAccountPayment extends string,
  ...
  TProgramAddress extends Address = typeof PROTECTED_PAY_PROGRAM_ADDRESS,
>(
  input: DelegatePaymentPermissionInput<
    TAccountPayer,
    TAccountSender,
    TAccountConfig,
    TAccountPayment,
...
export type ParsedDelegatePaymentPermissionInstruction<
  TProgram extends string = typeof PROTECTED_PAY_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DelegatePaymentPermissionInstructionData;
};

export function parseDelegatePaymentPermissionInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedDelegatePaymentPermissionInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDelegatePaymentPermissionInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
