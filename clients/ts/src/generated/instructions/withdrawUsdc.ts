...
export const WITHDRAW_USDC_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  114, 49, 72, 184, 27, 156, 243, 155,
]);

export function getWithdrawUsdcDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_USDC_DISCRIMINATOR,
  );
}

export type WithdrawUsdcInstruction<
...
export type WithdrawUsdcInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type WithdrawUsdcInstructionDataArgs = { amount: number | bigint };
...
export function getWithdrawUsdcInstructionDataEncoder(): FixedSizeEncoder<WithdrawUsdcInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WITHDRAW_USDC_DISCRIMINATOR }),
  );
}
...
export function getWithdrawUsdcInstructionDataCodec(): FixedSizeCodec<
  WithdrawUsdcInstructionDataArgs,
  WithdrawUsdcInstructionData
> {
  return combineCodec(
    getWithdrawUsdcInstructionDataEncoder(),
    getWithdrawUsdcInstructionDataDecoder(),
  );
}

export type WithdrawUsdcAsyncInput<
...
> = {
  ...
  amount: WithdrawUsdcInstructionDataArgs["amount"];
};

export async function getWithdrawUsdcInstructionAsync<
  TAccountUser extends string,
  TAccountConfig extends string,
  TAccountVault extends string,
  TAccountDeposit extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getWithdrawUsdcInstructionDataEncoder().encode(
      args as WithdrawUsdcInstructionDataArgs,
    ),
    programAddress,
  } as WithdrawUsdcInstruction<
    TProgramAddress,
    TAccountUser,
    TAccountConfig,
    TAccountVault,
...
export type ParsedWithdrawUsdcInstruction<
  TProgram extends string = typeof PROTECTED_PAY_PROGRAM_ADDRESS,
...
export function parseWithdrawUsdcInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedWithdrawUsdcInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getWithdrawUsdcInstructionDataDecoder().decode(instruction.data),
  };
}
