...
| Phase 4 | V1 LIVE RECOVERY PASS / V2 DELEGATED | Real v1 private open and recovery pass; v2 per-Payment escrow is live and a fresh settlement fixture is delegated without aggregate Deposit access | Privately open, acknowledge, schedule, settle, claim, and test retries |
...
3. **Next:** authenticate the sender and simulate a private open of 1 test USDC against the fresh version-2 Payment; do not broadcast until separately approved.
