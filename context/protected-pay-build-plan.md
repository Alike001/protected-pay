...
| Phase 4 | V1 LIVE RECOVERY PASS / V2.1 DEPLOYED / BOTH E2E PATHS PASS / RETRY SAFETY PASS | Settlement, unattended expiry, owner-only recovery, terminal no-op, and duplicate-claim rejection proven against live Private ER state | Repeat privacy audit and terminal commit/undelegate proof |
