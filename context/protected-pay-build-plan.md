...
| Phase 4 | V1 LIVE RECOVERY PASS / V2.1 DEPLOYED / SETTLEMENT E2E PASS / EXPIRY-RECOVERY E2E PASS | Expiry reached `Expired` at `+300s`; sender-only claim recovered escrow and redacted terms live | Prove retry idempotency, then repeat privacy/commit checks |
