...
| Phase 4 | V1 LIVE RECOVERY PASS / V2.1 DEPLOYED / STALLED RECOVERY PASS | Atomic private escrow and Payment-only scheduling finalized; six-call correction is deployed; the old-cadence escrow was atomically expired, claimed, and redacted | Prove both corrected live Crank terminal paths |
...
8. **Next:** prove the corrected real Crank lifecycle twice on fresh fixtures: acknowledged payment to settlement and abandoned payment to automatic expiry/refund, with both users offline and retries idempotent.
