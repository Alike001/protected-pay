...
| Phase 4 | V1 LIVE RECOVERY PASS / V2.1 DEPLOYED / STALLED RECOVERY PASS / FRESH SETTLEMENT BOOTSTRAP LIVE | Six-call correction is deployed; old escrow is recovered; fresh settlement shell/permission are finalized on Devnet | Delegate the fresh settlement fixture, then prove settlement and expiry live |
